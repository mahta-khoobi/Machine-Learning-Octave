...
% yk: each column in yk is one of the output units (1,2,3..,10) but it
% looks like this:   [1
%                     0
%                     0
%                     0
...
penalty = (lambda/(2*m))*(sum(sum(Theta1(:, 2:end).^2, 2)) + sum(sum(Theta2(:,2:end).^2, 2))); % using regularized cost func
J=J+ penalty;
